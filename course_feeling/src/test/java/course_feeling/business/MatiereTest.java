...
public class MatiereTest {
    ...
    public void MatiereTestSondage() {
        ...
        sondage1.addRessenti(Ressenti.Confus);
        ...
        sondage2.addRessenti(Ressenti.Confus);
    ...
    public void MatiereTestBeaucoupSondages() {
        ...
        assertEquals("Effraye", matiereTest2.getSondage(1000).getRessenti(0).toString());
    }
}
